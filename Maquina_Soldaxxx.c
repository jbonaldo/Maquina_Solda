...
//	InitFlash();
   ...
   ConfigCpuTimer(&CpuTimer0, 100, 23);  //Timer0, 100MHz, periodo=80us
...
//////////////////////////
	...
	//	Dog_Reset();
		...
		GerenciarSolda();	//Está no arquivo Solda_v1.c
		RecebePacote();		//Está no arquivo J_SciA_...c
...
void Configura_EPwm2()
{
   //Pulsos de disparo do SCR  Fase B	
   EPwm2Regs.TBPRD = Per120Hz;              // Set timer period = 100Mhz/16/120Hz (se deseja freq de 120Hz)
   EPwm2Regs.TBPHS.half.TBPHS = 17321;           // Phase is 0
   EPwm2Regs.TBCTR = 0x0000;                      // Clear counter
   EPwm2Regs.CMPA.half.CMPA = Per120Hz/2;			      //Duty_Cicle

   // Setup TBCLK
   EPwm2Regs.TBCTL.bit.CTRMODE = TB_COUNT_UP; 		// Count up
   EPwm2Regs.TBCTL.bit.PHSEN = TB_ENABLE;      	    // Habilita Sincronizacao
   EPwm2Regs.TBCTL.bit.HSPCLKDIV = 0x00;         	// dividido por 10; ePWM1_Clock=SYSCLKOUT/HSPCLKDIV/CLKDIV = SYSCLKOUT/160
   EPwm2Regs.TBCTL.bit.CLKDIV = 0x04;  			    //dividido por 16;
   EPwm2Regs.TBCTL.bit.SYNCOSEL = TB_SYNC_IN;       // Habilita sincronismo por software ou externo 
    

   EPwm2Regs.CMPCTL.bit.SHDWAMODE =  CC_IMMEDIATE; //TB_SHADOW;    //Registrador do comparador sem sombra 
   EPwm2Regs.CMPCTL.bit.SHDWBMODE =  CC_IMMEDIATE; //TB_SHADOW;
   EPwm2Regs.CMPCTL.bit.LOADAMODE = CC_CTR_ZERO;	  //Carrega CMPA qdo CTR=PRD 
   ...
   // Config. da interrupcao
   EPwm2Regs.ETSEL.bit.INTSEL = ET_CTRU_CMPA;     // Gera interrup qdo CTR=CMPA
   EPwm2Regs.ETSEL.bit.INTEN = 0;                // Disaable INT
   EPwm2Regs.ETPS.bit.INTPRD = ET_DISABLE;       // Inicia o timer nao gerando interrupcoes
   EPwm2Regs.ETCLR.bit.INT = 1;          	     // Clear INT flag for this timer 
...
void Configura_EPwm3()
{
   //Pulsos de disparo do SCR Fase C	
   EPwm3Regs.TBPRD = Per120Hz;              // Set timer period = 100Mhz/16/120Hz (se deseja freq de 120Hz)
   EPwm3Regs.TBPHS.half.TBPHS = 34722;           // Phase is 0
   EPwm3Regs.TBCTR = 0x0000;                      // Clear counter
   EPwm3Regs.CMPA.half.CMPA = Per120Hz/2;			      //Duty_Cicle

   // Setup TBCLK
   EPwm3Regs.TBCTL.bit.CTRMODE = TB_COUNT_UP; 		// Count up
   EPwm3Regs.TBCTL.bit.PHSEN = TB_ENABLE;      	    // Habilita Sincronizacao
   EPwm3Regs.TBCTL.bit.HSPCLKDIV = 0x00;         	// dividido por 10; ePWM1_Clock=SYSCLKOUT/HSPCLKDIV/CLKDIV = SYSCLKOUT/160
   EPwm3Regs.TBCTL.bit.CLKDIV = 0x04;  			    //dividido por 16;
   EPwm3Regs.TBCTL.bit.SYNCOSEL = TB_SYNC_IN;       // Habilita sincronismo por software ou externo 
    

   EPwm3Regs.CMPCTL.bit.SHDWAMODE =  CC_IMMEDIATE; //TB_SHADOW;    //Registrador do comparador sem sombra 
   EPwm3Regs.CMPCTL.bit.SHDWBMODE =  CC_IMMEDIATE; //TB_SHADOW;
   EPwm3Regs.CMPCTL.bit.LOADAMODE = CC_CTR_ZERO;	  //Carrega CMPA qdo CTR=PRD 
   ...
   // Config. da interrupcao
   EPwm3Regs.ETSEL.bit.INTSEL = ET_CTRU_CMPA;     // Gera interrup qdo CTR=CMPA
   EPwm3Regs.ETSEL.bit.INTEN = 0;                // Disaable INT
   EPwm3Regs.ETPS.bit.INTPRD = ET_DISABLE;       // Inicia o timer nao gerando interrupcoes
   EPwm3Regs.ETCLR.bit.INT = 1;          	     // Clear INT flag for this timer 
...
{
   //Pulsos de disparo do SCR Fase B
   EPwm5Regs.TBPRD = 125;                        // Set timer period = 100Mhz/160/5kHz (se deseja freq de 5KHz)
   EPwm5Regs.TBPHS.half.TBPHS = 0x0000;           // Phase is 0
   EPwm5Regs.TBCTR = 0x0000;                      // Clear counter
   EPwm5Regs.CMPA.half.CMPA = 16;		  //Duty_Cicle

   // Setup TBCLK
   EPwm5Regs.TBCTL.bit.CTRMODE = TB_COUNT_UP; 		// Count up
   EPwm5Regs.TBCTL.bit.PHSEN = TB_DISABLE;      	    // Habilita Sincronizacao
   EPwm5Regs.TBCTL.bit.HSPCLKDIV = 0x05;         	// dividido por 10; ePWM1_Clock=SYSCLKOUT/HSPCLKDIV/CLKDIV = SYSCLKOUT/160
   EPwm5Regs.TBCTL.bit.CLKDIV = 0x04;  			    //dividido por 16;
...
{
   //Pulsos de disparo do SCR Fase C	
   EPwm6Regs.TBPRD = 2300;                        // Set timer period = 100Mhz/160/5kHz (se deseja freq de 5KHz)
   EPwm6Regs.TBPHS.half.TBPHS = 0x0000;           // Phase is 0
   EPwm6Regs.TBCTR = 0x0000;                      // Clear counter
   EPwm6Regs.CMPA.half.CMPA = 1150;		  //Duty_Cicle

   // Setup TBCLK
   EPwm6Regs.TBCTL.bit.CTRMODE = TB_COUNT_UP; 		// Count up
   EPwm6Regs.TBCTL.bit.PHSEN = TB_DISABLE;      	    // Habilita Sincronizacao
   EPwm6Regs.TBCTL.bit.HSPCLKDIV = 0x0;         	// dividido por 10; ePWM1_Clock=SYSCLKOUT/HSPCLKDIV/CLKDIV = SYSCLKOUT/160
   EPwm6Regs.TBCTL.bit.CLKDIV = 0x0;  			    //dividido por 16;
...
void Configura_GPIO()
{
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO31 = 1;    // enable pull-up on GPIO31
	...
	GpioDataRegs.GPADAT.bit.GPIO19 = 1;		//inicia pino com zero
	GpioDataRegs.GPADAT.bit.GPIO25 = 0;		//inicia pino com 1		 //Reset do integrador externo
	GpioDataRegs.GPADAT.bit.GPIO27 = 1;		//inicia pino com zero

	GpioDataRegs.GPADAT.bit.GPIO31 = 0;		//inicia pino com zero
	...
	GpioCtrlRegs.GPAPUD.bit.GPIO21 = 1;    // enable pull-up on GPIO21 
